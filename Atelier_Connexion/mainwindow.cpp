...
////////////////////////////////////////
            QSqlQueryModel* model = p.afficher();
             ...
             QBarSet *set000 = new QBarSet("Mecanisian");
             QBarSet *set100 = new QBarSet("Electrisan");
             QBarSet *set200 = new QBarSet("Employee");
             *set000 << mecanisianPercentage;
             *set100 << electrisanPercentage;
             *set200 << employeePercentage;
             QBarSeries *series = new QBarSeries();
             series->append(set000);
             series->append(set100);
             series->append(set200);
...
//////////////////////////////////
    ...
    QBarSet *set3 = new QBarSet("demandes ARIANA");
        ...
        * set3 << 70<<100  ;
        ...
        chart5->setAxisX(axis7,series5);
        QChartView *chartView1 = new QChartView(chart5);
